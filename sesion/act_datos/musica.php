...
<body>
            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <a href="../act_datos/agg.php" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar disco</span></a>
    ...
    <!-- Edit Modal HTML -->
    <?php include("html/musica_crud/modal_edit.php"); ?>
    <?php include("html/musica_crud/modal_add.php"); ?>
    <?php include("html/musica_crud/modal_delete.php"); ?>
    <!-- Delete Modal HTML -->
    <script src="js/musica_script.js"></script>
</body>
