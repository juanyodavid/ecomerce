...
function load(page) {
  ...
  $("#loader").fadeIn("slow");
  $.ajax({
    url: "ajax/musica_ajax/vista_usuario.php",
    data: parametros,
...
$("#edit_product").submit(function (event) {
  ...
  $.ajax({
    type: "POST",
    url: "ajax/musica_ajax/editar_producto.php",
    data: parametros,
    beforeSend: function (objeto) {
...
$("#add_product").submit(function (event) {
  ...
  $.ajax({
    type: "POST",
    url: "ajax/musica_ajax/guardar_producto.php",
    data: parametros,
    beforeSend: function (objeto) {
      $("#resultados").html("Enviando...");
    },
...
$("#delete_product").submit(function (event) {
  ...
  $.ajax({
    type: "POST",
    url: "ajax/musica_ajax/eliminar_producto.php",
    data: parametros,
    beforeSend: function (objeto) {
      $("#resultados").html("Enviando...");
    },
