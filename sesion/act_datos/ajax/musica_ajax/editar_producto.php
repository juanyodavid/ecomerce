...
if (empty($_POST['edit_id'])) {
	...
	$disco = mysqli_real_escape_string($con, (strip_tags($_POST["disco_edit"], ENT_QUOTES)));
	...
	$sql = "UPDATE musica SET nombre='" . $nomap . "',     link='" . $link . "', id_disco='" . $disco . "', genero='" . $genero . "' WHERE id_musica='" . $id . "' ";
